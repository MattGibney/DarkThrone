...
- Product sunset: DarkThrone Reborn will shut down on 1 October 2026. New user-account registrations are closed; existing users may continue playing until shutdown. Public notices should link to the open-source repository at `https://github.com/MattGibney/DarkThrone` and direct players to `https://darkthronegame.com/`.
